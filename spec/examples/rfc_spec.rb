...
describe Schedule, 'occurs_on?' do
  ...
  it 'should ~ daily for 10 occurrences' do
    schedule = Schedule.new(Time.utc(2010, 9, 2))
  ...
  it 'should ~ daily until a certain date' do
    schedule = Schedule.new(Time.utc(1997, 9, 2))
    schedule.add_recurrence_rule Rule.daily.until(Time.utc(1997, 12, 24))
  ...
  it 'should ~ every other day' do
    schedule = Schedule.new(Time.utc(1997, 9, 2))
    schedule.add_recurrence_rule Rule.daily(2).until(Time.utc(1997, 12, 24))
  ...
  it 'should ~ everyday in january, for 3 years (a)' do
    schedule = Schedule.new(Time.utc(1998, 1, 1))
    schedule.add_recurrence_rule Rule.yearly.until(Time.utc(2000, 1, 31)).month_of_year(:january).day(:sunday, :monday, :tuesday, :wednesday, :thursday, :friday, :saturday)
  ...
  it 'should ~ everyday in january, for 3 years (b)' do
    schedule = Schedule.new(Time.utc(1998, 1, 1))
    schedule.add_recurrence_rule Rule.daily.month_of_year(:january).until(Time.utc(2000, 1, 31))
    dates = schedule.occurrences(Time.utc(2000, 1, 31))
    dates.each do |date|
      date.month.should == 1
      [1998, 1999, 2000].should include(date.year)
  ...
  it 'should ~ weekly until december 24, 1997' do
    schedule = Schedule.new(Time.utc(1997, 9, 2))
    schedule.add_recurrence_rule Rule.weekly.until(Time.utc(1997, 12, 24))
  ...
  it 'should ~ weekly on tuesday and thursday for 5 weeks (a)' do
    start_date = Time.utc(1997, 9, 2)
    schedule = Schedule.new(start_date)
    schedule.add_recurrence_rule Rule.weekly.until(Time.utc(1997, 10, 6)).day(:tuesday, :thursday)
  ...
  it 'should ~ every other week on monday, wednesday and friday until december 24, 1997 but starting on tuesday september 2, 1997' do
    start_date = Time.utc(1997, 9, 2)
    schedule = Schedule.new(start_date)
    schedule.add_recurrence_rule Rule.weekly(2).until(Time.utc(1997, 12, 24)).day(:monday, :wednesday, :friday)
    dates = schedule.occurrences(Time.utc(1997, 12, 24))
    expectation = []
  ...
  it 'should ~ monthly on the first friday until december 24, 1997' do
    start_date = Time.utc(1997, 9, 5)
    schedule = Schedule.new(start_date)
    schedule.add_recurrence_rule Rule.monthly.until(Time.utc(1997, 12, 24)).day_of_week(:friday => [1])
  ...
  it 'should ~ every 18 months on the 10th through the 15th of the month for 10 occurrences' do
    schedule = Schedule.new(Time.utc(1997, 9, 10))
  ...
  it 'should ~ yearly in june and july for 10 occurrences' do
    schedule = Schedule.new(Time.utc(1997, 6, 10))
  ...
  it 'should ~ every other year on january, feburary, and march for 10 occurrences' do
    schedule = Schedule.new(Time.utc(1997, 3, 10))
  ...
  it 'should ~ every third year on the 1st, 100th and 200th day for 10 occurrences' do
    schedule = Schedule.new(Time.utc(1997, 1, 1))
  ...
  it 'should ~ every thursday in march, forever' do
    schedule = Schedule.new(Time.utc(1997, 3, 13))
  ...
  it 'should ~ every thursday, but only during june, july, and august' do
    schedule = Schedule.new(Time.utc(1997, 6, 5))
  ...
  it 'should ~ the first saturday that follows the first sunday of the month' do
    schedule = Schedule.new(Time.utc(1997, 9, 13))
  ...
  it 'should ~ every 4 years, the first tuesday after a monday in november (u.s. presidential election day)' do
    schedule = Schedule.new(Time.utc(1996, 11, 5))
